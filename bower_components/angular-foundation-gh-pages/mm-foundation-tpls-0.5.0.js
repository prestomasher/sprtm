 ...
 * (c) Pinecone, LLC
 *
 * Accordion template modified by JC on Jan 1, 2015
 */
    ...
    .directive('offCanvasWrap', ['$window', function ($window) {
        return {
            ...
            link: function ($scope, element, attrs) {
                ...
                $scope.hide = function () {
                    sidebar.removeClass('offcanvas-overlap-left');  //Changed by JC
                    sidebar.removeClass('offcanvas-overlap-right'); //Changed by JC
                };
            ...
            controller: ['$scope', function($scope) {
                ...
                this.leftToggle = function() {
                    $scope.sidebar.toggleClass("offcanvas-overlap-right");  //Changed by JC
                };

                this.rightToggle = function() {
                    $scope.sidebar.toggleClass("offcanvas-overlap-left");   //Changed by JC
                };
...
angular.module("template/accordion/accordion-group.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/accordion/accordion-group.html",
    ...
    //Modified by JC to be able to override active content
    "  <div class=\"content\" ng-class=\"{ active: isOpen }\" ng-style=\"isOpen ? {display: 'block'} : {}\" ng-transclude></div>\n" +
    "</dd>\n" +
    "");
}]);
